...
def main(args=None):
    ...
    Sigma0 = np.eye(8)
    # TO ADJUST
    proc_noise_std = [1, 1, 0.5, 1, 1, 1, 1, 1] # [x, y, theta, v_x, v_y, w, a_x, a_y]
    ...
    motion_model_8d = acceleration_motion_model_linearized_2
    observation_model_8d = odometry_imu_observation_model_with_acceleration_motion_model_linearized_2
    ekf = ExtendedKalmanFilter(mu0, Sigma0,
                               motion_model_8d,
                               observation_model_8d,
